    ...
    <Router>
      <div className="min-h-screen min-h-dvh bg-background text-foreground font-body">
        <Routes>
          ...
          {/* Upload (authed) — worker cold-start (if needed) is surfaced inline
              in UploadView's processing panel, not gated here; the worker
              sleeps when idle and wakes on demand when an upload starts. */}
